...
class GeneClassifier:
    ...
    def label_data(self):
        ...
        group_1 = self.adata.var[self.adata.var.p_value >= 0.000005]
    ...
    def evaluate_classes(self):
        ...
        for index, feature in enumerate(self.test_features):
            ...
            prediction = tf.nn.softmax(result)
            predict_classes_train.append(self.class_list[np.argmax(prediction)])

        self.test_dataset['predict_class'] = predict_classes_train
