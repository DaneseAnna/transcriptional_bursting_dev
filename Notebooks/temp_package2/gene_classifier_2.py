...
class GeneClassifier_2:
    ...
    def __init__(self, adata=None, adata2=None):
        ...
        self.bias_init = None
        self.scaler_path = "../data/model/scaler_2.pkl"
        self.scaler = None
        self.model = None
        self.model_path = "../data/model/model_2.h5"
        self.checkpoint_path = "../data/model/checkpoints/cp_2.ckpt"
        # self.label_data()
    ...
    def label_data(self):
        ...
        group_1 = self.adata.var[self.adata.var.allele_p_value >= 0.00000005]
        group_2 = self.adata.var[self.adata.var.allele_p_value < 0.00000005]
        ...
        bi_allelic = group_1[((group_1.ratio_std_allele_c57 >= 0.1) & (group_1.ratio_std_allele_c57 <= 0.4)) &
                             ((group_1.sum_allele_c57 + group_1.sum_allele_cast) > 80)
                             ]
        ...
        parent_of_origin = group_2[((group_2.sum_ratio_allele_c57 <= 0.1) |
                                   ...
                                   ((group_2.sum_allele_c57 + group_2.sum_allele_cast) > 80)
                                   ]
        ...
        biased = other[
            ((other.allele_p_value < 0.00000005) & (other.ratio_std_allele_c57 <= 0.4)) &
            ((other.sum_allele_c57 + other.sum_allele_cast) > 80)
            ]
        ...
        tb_arme_1 = other[(other.allele_p_value < 0.00000005) &
                          (
        ...
        tb_arme_2 = other[(other.allele_p_value >= 0.00000005) &
                          ((other.ratio_std_allele_c57 > 0.4) & (other.ratio_std_allele_c57 < 0.6)) &
                          ((other.sum_allele_c57 + other.sum_allele_cast) > 80)
                          ]
    ...
    def get_aggregate_value(self):
        ...
        """
        allele_1 = pd.DataFrame(self.adata.layers['allele_c57'], columns=self.adata.var.index)
        allele_2 = pd.DataFrame(self.adata.layers['allele_cast'], columns=self.adata.var.index)
...
#                 print(prediction)
            ...
            allele_1 = pd.DataFrame(prediction_set.layers['allele_c57'], columns=prediction_set.var.index)
            allele_2 = pd.DataFrame(prediction_set.layers['allele_cast'], columns=prediction_set.var.index)
            allele_1_T = allele_1.transpose(copy=True)
            allele_2_T = allele_2.transpose(copy=True)
            allele_T = (allele_1_T - allele_2_T) / (allele_1_T + allele_2_T)
